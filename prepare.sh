...
if [ "$(uname)" == "Darwin" ]; then
  ...
  sudo apt-get install tk-dev ninja-build libglew-dev libglm-dev libcurl4-openssl-dev libboost-dev libxi-dev libgtk-3-dev libwxgtk3.0-gtk3-dev python-wxgtk3.0-dev python3-dev libboost-test-dev -y
else
  echo TODO
fi
